...
namespace stateMachinePlayer
{
    public abstract class StateMove : State
    {
        ...
        protected StateMove(StateMachine stateMachine, Player player, float speed, float rotationSpeed, float limitSpeed) : base(stateMachine, player)
        {
        ...
        public sealed override void FixedUpdate()
        {
            ...
            Vector3 directionVector = new Vector3(0, v, 0);
